    ...
    public class DbInitializer : IDbInitializer
    {
        ...
        public void Initializer()
        {
            ...
            ApplicationUser admin = new ApplicationUser()
            {
                ...
                Email = "carlos_admin@oliveira.com",
                EmailConfirmed = true,
            ...
            _user.CreateAsync(admin, "Oliveira123$").GetAwaiter().GetResult();
            ...
            ApplicationUser client = new ApplicationUser()
            {
                ...
                Email = "carlos_client@oliveira.com",
                EmailConfirmed = true,
                PhoneNumber = "+55 (62) 12345-6789",
                FirstName = "Carlos",
                LastName = "Client"
            ...
            _user.CreateAsync(client, "Oliveira123$").GetAwaiter().GetResult();
